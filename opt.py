...
po_value = st.number_input('Enter Required Portfolio Value in "SAR" - Min = 10 SAR, Max = 1,000,000 SAR:', min_value = 10, max_value = 1000000)
port_value = st.slider('Portfolio Value (SAR):', 1000, 1000000,po_value,step = 100, on_change = po_value)
