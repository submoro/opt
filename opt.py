...
po_value = st.number_input('Enter Required Portfolio Value in "SAR" :', min_value = 10, max_value = 1000000)
port_value = st.slider('Portfolio Value (SAR):', 1000, 1000000,10000,step = 100)
